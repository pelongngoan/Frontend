...
export class ManageOrderComponent implements OnInit {
  ...
  getProductsByCategory(value:any){
    this.productService.getProductByCateory(value.id).subscribe((response:any)=>{
  ...
  handleDeleteAction(value:any,elemennt:any){
    this.totalAmount = this.totalAmount-elemennt.total;
